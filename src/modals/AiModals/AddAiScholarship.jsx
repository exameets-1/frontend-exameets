...
export const AddAiScholarship = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!scholarshipDetails.trim()) {
            setError('Please enter scholarship details');
            return;
        }
        ...
        try {
            await onSubmit(scholarshipDetails.trim());
            setScholarshipDetails('');
            setError('');
        } catch (err) {
            setError(err.message || 'Failed to create AI scholarship');
        } finally {
            setIsLoading(false);
        }
    };
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-green-700 dark:text-green-400">
                                        Enter scholarship details in any format. AI will automatically extract key fields like department, location, category, deadlines, eligibility, salary, and application link.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="Example: The XYZ Scholarship is open for applications. Deadline: December 31, 2025. Eligibility: Must be a full-time student. Apply at: https://xyzscholarship.com"
                                rows={12}
                            ...
                            <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <span>{scholarshipDetails.length} characters</span>
                            </div>
                        </div>
                    ...
                    <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading || !scholarshipDetails.trim() || scholarshipDetails.trim().length < 10}
...
export default AddAiScholarship;
