...
export const AddAiResult = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!resultDetails.trim()) {
            setError('Please enter result details');
            return;
        }
        ...
        try {
            await onSubmit(resultDetails.trim());
            setResultDetails('');
            setError('');
        } catch (err) {
            setError(err.message || 'Failed to create AI result');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleInputChange = (e) => {
        setResultDetails(e.target.value);
        if (error) {
            setError('');
        }
    };
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-green-700 dark:text-green-400">
                                        Enter result details in any format. AI will automatically extract key fields like department, location, category, deadlines, eligibility, salary, and application link.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <span>{resultDetails.length} characters</span>
                            </div>
                        </div>
                    ...
                    <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading || !resultDetails.trim() || resultDetails.trim().length < 10}
