...
const AddAiJob = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await onSubmit(jobDetails.trim());
            setJobDetails('');
            setError('');
        } catch (err) {
            setError(err.message || 'Failed to create AI job');
        } finally {
            setIsLoading(false);
        }
    };
                    ...
                    <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-blue-700 dark:text-blue-400">
                                        Enter job details in any format. Our AI will process and structure the information automatically, extracting job title, location, type, salary, skills, eligibility, and other relevant details.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="Example: 
Turing is hiring Fullstack Developers to build scalable AI applications. Location: Remote (India). Salary: 8-15 LPA. Type: Contract. Skills: React, Node.js, MongoDB. Apply by July 15, 2025."
                                rows={12}
                            ...
                            <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <span>{jobDetails.length} characters</span>
                            </div>
                        </div>
                    ...
                    <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading || !jobDetails.trim() || jobDetails.trim().length < 10}
