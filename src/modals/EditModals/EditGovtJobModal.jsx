...
const EditGovtJobModal = ({ isOpen, onClose, job, jobId, onUpdate }) => {
    ...
    const handleAddItem = (field) => {
        ...
        setFormData(prev => ({
            ...prev,
            [field]: [...prev[field], ...currentInputs[field].split(',').map(item => item.trim())]
        }));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await onUpdate({ jobId, updatedData: formData });
            onClose();
        } catch (error) {
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white dark:bg-gray-900 rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl">
                <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Edit Government Job</h2>
...
export default EditGovtJobModal;