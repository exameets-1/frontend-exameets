        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl">
                <div className="flex justify-between items-center p-6 border-b border-gray-200">
                    <h2 className="text-2xl font-bold text-gray-800">Add New Government Job</h2>
                            ...
                            <div key={fieldName} className={fieldInfo.type === 'checkbox' ? 'md:col-span-2' : ''}>
                                {fieldInfo.type === 'checkbox' ? (
                                    <label className="flex items-center space-x-3">
                                        ...
                                        />
                                        <span className="text-gray-700 font-medium">{fieldInfo.label}</span>
                                    </label>
                                ) : (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                {formData.faq.map((item, index) => (
                                    <div key={index} className="bg-gray-100 p-4 rounded-lg flex flex-col gap-2">
