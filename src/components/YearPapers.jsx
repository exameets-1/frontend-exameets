        ...
        <div className="min-h-screen bg-white">
            <div className="max-w-7xl mx-auto px-5 py-10">
                <header className="mb-10 text-center">
                    <h1 className="text-4xl font-bold text-[#015990] mb-2">
                        {decodeURIComponent(subjectSlug)} - {year} Papers
                    </h1>
                    <p className="text-lg text-gray-600">Detailed view of all question papers</p>
                </header>

                {editedPapers.map((paper, index) => (
                    <div key={paper._id} className="bg-white rounded-lg shadow-lg mb-8 p-8">
                        {/* Header Section */}
                            ...
                            <div>
                                {isEditing ? (
                                    <input
                                        ...
                                        className="text-3xl font-bold text-gray-800 mb-2 w-full border p-2 rounded"
                                    />
                                ) : (
                                    <h2 className="text-3xl font-bold text-gray-800 mb-2">{paper.title}</h2>
                                )}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2">
                                <div className="bg-gray-50 rounded-lg p-6 mb-6">
                                    <h3 className="text-xl font-semibold text-[#015990] mb-4">Paper Overview</h3>
                                    {isEditing ? (
                                        <textarea
                                    ...
                                    <h3 className="text-xl font-semibold text-[#015990] mb-4 mt-6">Search Information</h3>
                                    {isEditing ? (
                                        <textarea
                                ...
                                <div className="bg-gray-50 rounded-lg p-6">
                                    <h3 className="text-xl font-semibold text-[#015990] mb-4">Exam Details</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {["exam_name", "subject", "year"].map((field) => (
                                            <div key={field} className="bg-white p-4 rounded-lg">
                                                ...
                                                {isEditing ? (
                                                    ...
                                                    <p className="font-medium text-gray-800">{paper[field]}</p>
                                                )}
                                            </div>
                                        ))}
                                        ...
                                        <div className="bg-white p-4 rounded-lg">
                                            ...
                                            {isEditing ? (
                                                ...
                                                <p className="font-medium text-gray-800">{paper.category}</p>
                                            )}
                                        </div>
                                        ...
                                        <div className="bg-white p-4 rounded-lg">
                                            ...
                                            {isEditing ? (
                                                ...
                                                <p className="font-medium text-gray-800">{paper.slug}</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="lg:col-span-1">
                                <div className="bg-gray-50 rounded-lg p-6">
                                    <h3 className="text-xl font-semibold text-[#015990] mb-4">Keywords</h3>
                                    {isEditing ? (
                ...
                {!editedPapers.length && (
                    <div className="text-center py-20">
                        <div className="text-2xl text-gray-500 mb-4">No papers found for {year}</div>
                        <p className="text-gray-600">Please check back later or try a different year</p>
                    </div>
                )}
            </div>
        </div>
